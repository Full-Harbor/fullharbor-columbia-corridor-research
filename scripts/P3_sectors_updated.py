...
# NTEE major categories — baseline reference
NTEE_MAJOR_GROUPS = {
    'A': 'Arts, Culture, Humanities',
    'B': 'Education & Research',
    'C': 'Environment & Animals',
    'D': 'Animal-Related (includes D01-D99)',
    'E': 'Health Care',
    'F': 'Mental Health & Crisis Intervention',
    'G': 'Fund Raising & Grantmaking',
    'H': 'Social Services',
    'I': 'Civil Rights & Advocacy',
    'J': 'Community Improvement & Development',
    'K': 'Housing & Shelter',
    'L': 'Public Safety',
    'M': 'Recreation & Sports',
    'N': 'Youth Development',
    'O': 'International / Foreign Affairs',
    'P': 'Religion-Related (X = Ethnic/Race)',
    'Q': 'Mutual & Membership Benefit',
    'R': 'Science & Technology',
    'S': 'Social Science',
    'T': 'Grantmaking Foundations',
    'U': 'Voluntarism & Grantmaking Support',
    'V': 'Mutual Benefit Orgs',
    'W': 'Unknown',
    'X': 'Religion-Related (X = Tribal/Indigenous)',
    'Y': 'Unknown',
    'Z': 'Unknown',
}
